...
geo_file = "geojson/Brasil/saopaulo.geojson"
...
if os.path.exists("saopaulo_final.geojson"):
    os.remove("saopaulo_final.geojson")
else:
    print('file doesn''t exist')

with open("saopaulo_final.geojson", "w") as jsonFileFinal:
...
with open('saopaulo_final.geojson') as json_file:
...
fig = go.Figure(go.Choroplethmapbox(
    ...
    z = df['pop_density_2010'], # Data to be color-coded
    # locationmode = 'USA-states', # set of locations match entries in `locations`
    colorscale=[[0, '#ffc33e'], [0.5, '#ff0000'], [1, '#000']], zmin=0,zmax=20000,
...
# original
fig.write_image("images/saopaulo.png", engine="kaleido")
print("image saved")
