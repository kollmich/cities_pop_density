...
geo_file = "geojson/China/shanghai.geojson"
...
if os.path.exists("shanghai_final.geojson"):
    os.remove("shanghai_final.geojson")
else:
    print('file doesn''t exist')

with open("shanghai_final.geojson", "w") as jsonFileFinal:
...
with open('shanghai_final.geojson') as json_file:
    shanghai = json.load(json_file)
...
fig = go.Figure(go.Choroplethmapbox(
    ...
    colorscale=[[0, '#ffc33e'], [0.3, '#ff0000'], [1, '#000']], zmin=0,zmax=33000,
    marker_opacity=0.65, marker_line_width=1.5,marker_line_color='#fff',text=df['name_en']
))
...
# original
fig.write_image("images/shanghai.png", engine="kaleido")
print("image saved")
